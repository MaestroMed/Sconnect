 ...
 *
 * Under `prefers-reduced-motion`, drops the animations and renders a
 * simpler 3-orb static backdrop to avoid jank.
 */
    ...
    <div aria-hidden="true" className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      ...
      <div
        className={cn(
          "aurora-ring",
          opacity,
          !freeze && "aurora-ring-animate",
        )}
      />
      {/* Drifting orbs — layered, differing speeds */}
      <div className={cn("orb orb-soft h-[55vw] w-[55vw] max-h-[620px] max-w-[620px] -left-[10%] -top-[15%] bg-primary-500/40", !freeze && "animate-drift")} />
      <div className={cn("orb h-[45vw] w-[45vw] max-h-[520px] max-w-[520px] right-[-8%] top-[10%] bg-electric-500/35", !freeze && "animate-drift-reverse")} />
      <div className={cn("orb orb-soft h-[60vw] w-[60vw] max-h-[700px] max-w-[700px] left-[20%] bottom-[-20%] bg-violet-500/30", !freeze && "animate-orb-float")} />
      {!freeze && (
