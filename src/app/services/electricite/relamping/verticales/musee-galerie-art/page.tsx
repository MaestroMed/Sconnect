...
// Auto-generated from seo-backlog.json item "vertical-musee-galerie" on 2026-05-21.
...
export const metadata: Metadata = {
  title: "Relamping LED musée et galerie d'art — IRC > 95, sécurité œuvres, muséographie | S Connect",
  description:
    "Spécialiste relamping LED à Musée / Galerie d'art (IDF) : audit gratuit, étude personnalisée, installation, conformité NF EN 12464-1, accompagnement décret tertiaire. Devis sous 7 jours.",
  keywords: [
    "relamping LED musée galerie art",
    "éclairage muséographique LED", "IRC 95 galerie art",
  ],
...
const serviceSchema = generateServiceSchema(
  {
    name: "Relamping LED à Musée / Galerie d'art",
    description:
      "Audit, étude et installation relamping LED pour bureaux, commerces, copropriétés et industriels à Musée / Galerie d'art et alentours. Conformité NF EN 12464-1 et décret tertiaire (DEET) couverts.",
    provider: "S Connect",
    areaServed: ["Musée / Galerie d'art", "Île-de-France"],
    priceRange: "€€€",
  },
  siteUrl,
);

export default function RelampingMuseGaleriedartPage() {
  return (
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight [text-shadow:_0_2px_20px_rgba(0,0,0,0.6)]">
              Relamping LED à {"Musée / Galerie d'art"}
            </h1>
            ...
            <p className="text-lg text-white/90 leading-relaxed [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)]">
              S Connect intervient sur tout Musée / Galerie d'art et la couronne immédiate. Bureaux,
      ...
      {/* Pourquoi nous pour Musée / Galerie d'art */}
      <section className="section-padding bg-surface">
        <div className="container-custom max-w-4xl">
          <SectionTitle
            badge="Pourquoi S Connect à Musée / Galerie d'art"
            title="L'expertise éclairage locale, sans intermédiaire"
            subtitle="Basés à Clichy, nous intervenons sur Musée / Galerie d'art en moins de 40 min. Notre équipe sait calibrer un éclairage pour chaque typologie de local de la ville."
          />
      ...
      <section className="section-padding bg-surface-muted">
        <div className="container-custom max-w-5xl">
          <SectionTitle
            ...
            title="Quelle solution pour votre local à Musée / Galerie d'art ?"
          />
        ...
        <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="font-display font-bold text-2xl md:text-3xl mb-2">
              Auditons votre éclairage à {"Musée / Galerie d'art"} gratuitement
            </h2>
