...
// Auto-generated from seo-backlog.json item "vertical-centre-commercial" on 2026-05-21.
...
export const metadata: Metadata = {
  title: "Relamping LED centre commercial — pilotage zones, variation circadienne, ROI 24 mois | S Connect",
  description:
    "Spécialiste relamping LED à Centre commercial (IDF) : audit gratuit, étude personnalisée, installation, conformité NF EN 12464-1, accompagnement décret tertiaire. Devis sous 7 jours.",
  keywords: [
    "relamping LED centre commercial",
    "éclairage galerie marchande", "DALI centre commercial",
  ],
...
const serviceSchema = generateServiceSchema(
  {
    name: "Relamping LED à Centre commercial",
    description:
      "Audit, étude et installation relamping LED pour bureaux, commerces, copropriétés et industriels à Centre commercial et alentours. Conformité NF EN 12464-1 et décret tertiaire (DEET) couverts.",
    provider: "S Connect",
    areaServed: ["Centre commercial", "Île-de-France"],
    priceRange: "€€€",
  },
  siteUrl,
);
...
export default function RelampingCentrecommercialPage() {
  return (
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight [text-shadow:_0_2px_20px_rgba(0,0,0,0.6)]">
              Relamping LED à {"Centre commercial"}
            </h1>
            ...
            <p className="text-lg text-white/90 leading-relaxed [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)]">
              S Connect intervient sur tout Centre commercial et la couronne immédiate. Bureaux,
      ...
      {/* Pourquoi nous pour Centre commercial */}
      <section className="section-padding bg-surface">
        <div className="container-custom max-w-4xl">
          <SectionTitle
            badge="Pourquoi S Connect à Centre commercial"
            title="L'expertise éclairage locale, sans intermédiaire"
            subtitle="Basés à Clichy, nous intervenons sur Centre commercial en moins de 40 min. Notre équipe sait calibrer un éclairage pour chaque typologie de local de la ville."
          />
      ...
      <section className="section-padding bg-surface-muted">
        <div className="container-custom max-w-5xl">
          <SectionTitle
            ...
            title="Quelle solution pour votre local à Centre commercial ?"
          />
        ...
        <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="font-display font-bold text-2xl md:text-3xl mb-2">
              Auditons votre éclairage à {"Centre commercial"} gratuitement
            </h2>
