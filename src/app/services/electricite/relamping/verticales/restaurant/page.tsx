...
// Auto-generated from seo-backlog.json item "vertical-restaurant" on 2026-05-20.
...
export const metadata: Metadata = {
  title: "Relamping LED restaurant — ambiance modulable, températures de couleur multi-zones | S Connect",
  description:
    "Spécialiste relamping LED à Restaurant (IDF) : audit gratuit, étude personnalisée, installation, conformité NF EN 12464-1, accompagnement décret tertiaire. Devis sous 7 jours.",
  keywords: [
    "relamping LED restaurant",
    "éclairage restaurant", "ambiance LED salle",
  ],
...
const serviceSchema = generateServiceSchema(
  {
    name: "Relamping LED à Restaurant",
    description:
      "Audit, étude et installation relamping LED pour bureaux, commerces, copropriétés et industriels à Restaurant et alentours. Conformité NF EN 12464-1 et décret tertiaire (DEET) couverts.",
    provider: "S Connect",
    areaServed: ["Restaurant", "Île-de-France"],
    priceRange: "€€€",
  },
  siteUrl,
);
...
export default function RelampingRestaurantPage() {
  return (
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white/90 leading-relaxed [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)]">
              S Connect intervient sur tout Restaurant et la couronne immédiate. Bureaux,
      ...
      {/* Pourquoi nous pour Restaurant */}
      <section className="section-padding bg-surface">
        <div className="container-custom max-w-4xl">
          <SectionTitle
            badge="Pourquoi S Connect à Restaurant"
            title="L'expertise éclairage locale, sans intermédiaire"
            subtitle="Basés à Clichy, nous intervenons sur Restaurant en moins de 40 min. Notre équipe sait calibrer un éclairage pour chaque typologie de local de la ville."
          />
      ...
      <section className="section-padding bg-surface-muted">
        <div className="container-custom max-w-5xl">
          <SectionTitle
            ...
            title="Quelle solution pour votre local à Restaurant ?"
          />
        ...
        <div className="container-custom relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h2 className="font-display font-bold text-2xl md:text-3xl mb-2">
              Auditons votre éclairage à {"Restaurant"} gratuitement
            </h2>
