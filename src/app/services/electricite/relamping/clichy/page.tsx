...
// Auto-generated from seo-backlog.json item "location-clichy" on 2026-05-20.
...
export const metadata: Metadata = {
  title: "Relamping LED à Clichy — l'expertise locale S Connect, basée 35 rue des Cailloux | S Connect",
  description:
    "Spécialiste relamping LED à Clichy (92110) : audit gratuit, étude personnalisée, installation, conformité NF EN 12464-1, accompagnement décret tertiaire. Devis sous 7 jours.",
  keywords: [
    "relamping LED Clichy",
    "électricien LED Clichy", "audit éclairage 92110",
  ],
...
const serviceSchema = generateServiceSchema(
  {
    name: "Relamping LED à Clichy",
    description:
      "Audit, étude et installation relamping LED pour bureaux, commerces, copropriétés et industriels à Clichy et alentours. Conformité NF EN 12464-1 et décret tertiaire (DEET) couverts.",
    provider: "S Connect",
    areaServed: ["Clichy", "Île-de-France"],
    priceRange: "€€€",
  },
  siteUrl,
);
...
export default function RelampingClichyPage() {
  return (
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white/90 leading-relaxed [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)]">
              S Connect intervient sur tout Clichy et la couronne immédiate. Bureaux,
      ...
      {/* Pourquoi nous pour Clichy */}
      <section className="section-padding bg-surface">
        <div className="container-custom max-w-4xl">
          <SectionTitle
            badge="Pourquoi S Connect à Clichy"
            title="L'expertise éclairage locale, sans intermédiaire"
            subtitle="Basés à Clichy, nous intervenons sur Clichy en moins de 40 min. Notre équipe sait calibrer un éclairage pour chaque typologie de local de la ville."
          />
