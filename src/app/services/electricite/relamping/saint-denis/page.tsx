...
// Auto-generated from seo-backlog.json item "location-saint-denis" on 2026-05-20.
...
export const metadata: Metadata = {
  title: "Relamping LED à Saint-Denis (93) — industriels, entrepôts, ERP | S Connect",
  description:
    "Spécialiste relamping LED à Saint-Denis (93200) : audit gratuit, étude personnalisée, installation, conformité NF EN 12464-1, accompagnement décret tertiaire. Devis sous 7 jours.",
  keywords: [
    "relamping LED Saint-Denis",
    "éclairage industriel Saint-Denis", "audit LED 93200",
  ],
...
const serviceSchema = generateServiceSchema(
  {
    name: "Relamping LED à Saint-Denis",
    description:
      "Audit, étude et installation relamping LED pour bureaux, commerces, copropriétés et industriels à Saint-Denis et alentours. Conformité NF EN 12464-1 et décret tertiaire (DEET) couverts.",
    provider: "S Connect",
    areaServed: ["Saint-Denis", "Île-de-France"],
    priceRange: "€€€",
  },
  siteUrl,
);
...
export default function RelampingSaintDenisPage() {
  return (
    <>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white/90 leading-relaxed [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)]">
              S Connect intervient sur tout Saint-Denis et la couronne immédiate. Bureaux,
      ...
      {/* Pourquoi nous pour Saint-Denis */}
      <section className="section-padding bg-surface">
        <div className="container-custom max-w-4xl">
          <SectionTitle
            badge="Pourquoi S Connect à Saint-Denis"
            title="L'expertise éclairage locale, sans intermédiaire"
            subtitle="Basés à Clichy, nous intervenons sur Saint-Denis en moins de 40 min. Notre équipe sait calibrer un éclairage pour chaque typologie de local de la ville."
          />
      ...
      <section className="section-padding bg-surface-muted">
        <div className="container-custom max-w-5xl">
          <SectionTitle
            ...
            title="Quelle solution pour votre local à Saint-Denis ?"
          />
