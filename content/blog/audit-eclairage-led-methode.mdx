...
howTo:
  ...
  steps:
    ...
    - name: "Estimation du financement"
      text: "Chiffrer le ROI par l'économie d'énergie (les fiches CEE éclairage sont supprimées depuis février 2026) et évaluer les leviers de financement adaptés : leasing, éco-PTZ Pro, sur-amortissement énergétique."
    - name: "Livraison du rapport chiffré"
      text: "Document final avec photos avant/après simulation, plan de calepinage, devis ferme matériel et pose, ROI précis et plan de phasage du chantier."
---
...
## 6. Le calcul du ROI et du financement
...
> **Note CEE** : jusqu'en février 2026, une prime CEE (fiches BAT-EQ-127/130, IND-UT-130) s'ajoutait à ce calcul et couvrait 30 à 45 % du coût matériel + pose. Ces fiches ont été **supprimées le 25 février 2026** : le ROI se calcule désormais sur la seule économie d'énergie + maintenance, et le financement passe par d'autres leviers (leasing, éco-PTZ Pro, sur-amortissement) — voir [financer un relamping sans CEE](/actualites/financer-relamping-led-sans-cee-2026).

Nous publions tous les chiffres dans le devis : hypothèses, tarif kWh retenu, heures d'usage. Pas d'estimation vague — le calcul est vérifiable ligne à ligne.
...
4. **Plan de financement** : leasing vs achat, éco-PTZ Pro, sur-amortissement le cas échéant
...
7. **ROI net** : mois précis de retour sur investissement
